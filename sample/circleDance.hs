...
cols = [setColor c | c <- cycle [col1, col2, col3, col4, col5, col6]]
  where
    col1 = makeColor 0.0 0.0 0.2 1
    col2 = makeColor 0.0 0.2 0.0 1
    col3 = makeColor 0.0 0.2 0.2 1
    col4 = makeColor 0.2 0.0 0.0 1
    col5 = makeColor 0.2 0.0 0.2 1
    col6 = makeColor 0.2 0.2 0.0 1

angles :: [Command]
angles = [setAngle th | th <- [30, 60 .. 360]]

circleDance :: Command
circleDance = repCommand 3 [circle', lt 10]
  where
